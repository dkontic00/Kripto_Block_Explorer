...
while flag:
    ...
    print("Za pretragu po visini bloka - 1\nZa pretragu po transakciji IDa - 2\nZa pregled statistike bloka - 3\n"
          ...
          "Za informacije o mreži čvora - 7\nZa pregled nedavnih transakcija - 8\n"
          "Za ispis poteškoće - 9\nPrekid - 0")
    ...
    if odabir == 1:
       ...
       # Unos visine bloka i dohvaćanje bloka getblockhash() funkcijom
        ...
        # Dohvaćanje nedavnih transakcija
        listaNedavnihTransakcija = client.listtransactions()
        print("---Pregled nedavnih transakcija---")
        if not listaNedavnihTransakcija:
            print("Nema nedavnih transakcija")
        else:
            print("Nedavne transakcije:", listaNedavnihTransakcija)
        print("------\n")
